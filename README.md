...
python3 odoo-bin --db_host=127.0.0.1 --database=postgres --db_user=admin --db_password=123456789 -i base

python3 odoo-bin --addons-path=addons --db_host=127.0.0.1 --database=postgres --db_user=admin --db_password=123456789